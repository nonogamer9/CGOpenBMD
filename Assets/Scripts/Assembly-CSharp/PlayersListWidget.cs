...
public class PlayersListWidget : MonoBehaviour
{
	...
	public void ShowPlayersList()
	{
		...
		{
			totalListContainer.parent.parent.gameObject.SetActive(false);
			myteamListContainer.parent.parent.gameObject.SetActive(true);
			enemyListContainer.parent.parent.gameObject.SetActive(true);
		}
		else
		{
			totalListContainer.parent.parent.gameObject.SetActive(true);
			myteamListContainer.parent.parent.gameObject.SetActive(false);
			enemyListContainer.parent.parent.gameObject.SetActive(false);
		}
