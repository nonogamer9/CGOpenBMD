	...
	private void OnGUI()
	{
		...
		for (int i = 0; i < GUIContents.Length; i++)
		{
			...
			else
			{
				...
				{
					animator[k].SetBool("walkToIdle2", false);
					animator[k].SetBool("runToIdle2", false);
					animator[k].SetBool("deathToIdle2", false);
				}
			}
			...
			if (currentAnimatorStateInfo.IsName("Base Layer.walk") && currentState != "walk")
			{
				...
				{
					animator[l].SetBool("walkToIdle2", true);
				}
			}
			if (currentAnimatorStateInfo.IsName("Base Layer.run") && currentState != "run")
			{
				...
				{
					animator[m].SetBool("runToIdle2", true);
				}
			}
			if (currentAnimatorStateInfo.IsName("Base Layer.death") && currentState != "death")
			{
				...
				{
					animator[n].SetBool("deathToIdle2", true);
				}
			}
			switch (currentState)
			{
			case "idle0":
			{
				...
				{
					animator[num4].SetBool("idle2ToIdle0", true);
				}
				break;
			}
			case "idle1":
			{
				...
				{
					animator[num8].SetBool("idle2ToIdle1", true);
				}
				break;
			}
			case "walk":
			{
				...
				{
					animator[num10].SetBool("idle2ToWalk", true);
				}
				break;
			}
			case "run":
			{
				...
				{
					animator[num6].SetBool("idle2ToRun", true);
				}
				break;
			}
			case "attack0":
			{
				...
				{
					animator[num2].SetBool("idle2ToAttack0", true);
				}
				break;
			}
			case "attack1":
			{
				...
				{
					animator[num9].SetBool("idle2ToAttack1", true);
				}
				break;
			}
			case "skill0":
			{
				...
				{
					animator[num7].SetBool("idle2ToSkill0", true);
				}
				break;
			}
			case "skill1":
			{
				...
				{
					animator[num5].SetBool("idle2ToSkill1", true);
				}
				break;
			}
			case "wound":
			{
				...
				{
					animator[num3].SetBool("idle2ToWound", true);
				}
				break;
			}
			case "death":
			{
				...
				{
					animator[num].SetBool("idle2ToDeath", true);
				}
				break;
			}
			}
