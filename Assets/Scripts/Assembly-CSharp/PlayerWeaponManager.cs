...
public class PlayerWeaponManager : Photon.MonoBehaviour
{
	...
	private void Awake()
	{
		...
		buffedredGuns.AddRange(gunsContainer.GetComponentsInChildren<BaseWeaponScript>(true));
	...
	public List<BaseWeaponScript> AllPlayerGuns()
	{
		...
		{
			BoughtWeapons = new List<BaseWeaponScript>();
			BoughtWeapons.AddRange(gunsContainer.GetComponentsInChildren<BaseWeaponScript>(true));
		}
	...
	public List<BaseWeaponScript> AllPlayerBoughtGuns()
	{
		...
		list.AddRange(gunsContainer.GetComponentsInChildren<BaseWeaponScript>(true));
