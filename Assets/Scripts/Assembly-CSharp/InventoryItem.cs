...
public class InventoryItem : Photon.MonoBehaviour, IDestroyable
{
	...
	public string CategoryFolderName
	{
		get
		{
			return Array.Find(DataModel.instance.InventoryCategories, (InventoryCategory ctg) => ctg.id == categoryId).name;
		}
	}

	public string FullPathToPrefab
	{
		get
		{
			return "Prefabs/Inventory/" + CategoryFolderName + "/" + prefabName;
		}
	}
