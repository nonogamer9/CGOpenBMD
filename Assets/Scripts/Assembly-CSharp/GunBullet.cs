...
public class GunBullet : BaseBulletScript
{
	...
	protected override void RaycastForTarget()
	{
		...
		showBloodFX = false;
		RaycastHit hitInfo;
		if (!Physics.Linecast(base.transform.position, base.transform.position + base.transform.forward * 250f, out hitInfo, targetLayers, QueryTriggerInteraction.Collide))
		{
			return;
		}
