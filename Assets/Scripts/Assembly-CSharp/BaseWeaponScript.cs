...
public class BaseWeaponScript : Photon.MonoBehaviour
{
	...
	public class GunInfo
	{
		...
		public float damage
		{
			get
			{
				return gunParams[currentLevel].damage;
			}
		}
		...
		public float damagePerSec
		{
			get
			{
				return gunParams[currentLevel].damagePerSecond;
			}
		}
		...
		public float firerate
		{
			get
			{
				return gunParams[currentLevel].firerate;
			}
		}
		...
		public float accurancy
		{
			get
			{
				return gunParams[currentLevel].accurancy;
			}
		}
		...
		public int currentUpgradePrice
		{
			get
			{
				return gunParams[currentLevel].upgradePrice;
			}
		}
		...
		public bool isFullyUpgraded
		{
			get
			{
				return currentLevel == maxUpgradeLevel - 1;
			}
		}
	...
	public int parentViewID
	{
		get
		{
			return parentPhotonView.viewID;
		}
	}
	...
	public string gunId
	{
		get
		{
			return GetComponent<ShopItem>().id;
		}
	}
