...
public class CarController : Vehicle, IShootable
{
	...
	private InventoryCarObject MyInventory
	{
		get
		{
			return GetComponent<InventoryCarObject>();
		}
	}
	...
	{
		yield return _003CStart_003E__BaseCallProxy0();
	...
	protected override void Update()
	{
		...
		{
			OnOwnerTransfer(false);
		}
		else if (!isClone && !base.photonView.isMine)
		{
			OnOwnerTransfer(true);
		}
	...
	public override void OnPlayerSitMeRPC(int playerViewId)
	{
		...
		if (base.photonView.isMine)
		{
			...
			carCloneAssist.StopEngineSound(false);
			EnableShadow(true);
		}
	...
	protected override void DisablePhysics()
	{
		...
		{
			base.DisablePhysics();
			carCloneAssist.StopEngineSound(true);
		}
	}
	...
	{
		Projector componentInChildren = base.gameObject.GetComponentInChildren<Projector>(true);
