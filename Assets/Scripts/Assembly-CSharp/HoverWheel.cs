...
public class HoverWheel : MonoBehaviour
{
	...
	private void TiltWheel()
	{
		...
		obj.localRotation = Quaternion.Lerp(localRotation, Quaternion.LookRotation(vector.normalized, Vector3.forward), visualTiltRate * Time.deltaTime);
	}
