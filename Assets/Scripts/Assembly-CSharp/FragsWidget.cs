...
public class FragsWidget : MonoBehaviour
{
	...
	private IEnumerator OnOurPlayerCreateCrt(CharacterMotor player)
	{
		...
		{
			teamA_indc.SetActive(true);
		}
		else
		{
			teamB_indc.SetActive(true);
		}
	}
