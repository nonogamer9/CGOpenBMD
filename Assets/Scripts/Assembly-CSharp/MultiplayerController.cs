...
public class MultiplayerController : Photon.MonoBehaviour
{
	...
	private static PhotonRoomPropertiesChanged RoomPropertiesChanged__BackingField;
	...
	public static event PhotonRoomPropertiesChanged RoomPropertiesChanged
	{
		add
		{
			PhotonRoomPropertiesChanged photonRoomPropertiesChanged = RoomPropertiesChanged__BackingField;
			PhotonRoomPropertiesChanged photonRoomPropertiesChanged2;
			do
			{
				photonRoomPropertiesChanged2 = photonRoomPropertiesChanged;
				photonRoomPropertiesChanged = Interlocked.CompareExchange(ref RoomPropertiesChanged__BackingField, (PhotonRoomPropertiesChanged)Delegate.Combine(photonRoomPropertiesChanged2, value), photonRoomPropertiesChanged);
			}
			while ((object)photonRoomPropertiesChanged != photonRoomPropertiesChanged2);
		}
		remove
		{
			PhotonRoomPropertiesChanged photonRoomPropertiesChanged = RoomPropertiesChanged__BackingField;
			...
			{
				photonRoomPropertiesChanged2 = photonRoomPropertiesChanged;
				photonRoomPropertiesChanged = Interlocked.CompareExchange(ref RoomPropertiesChanged__BackingField, (PhotonRoomPropertiesChanged)Delegate.Remove(photonRoomPropertiesChanged2, value), photonRoomPropertiesChanged);
			}
			while ((object)photonRoomPropertiesChanged != photonRoomPropertiesChanged2);
		}
	}
	...
	private void OnJoinedRoom()
	{
		...
		UnityEngine.Debug.Log("OnJoinedRoom map = " + mapID);
	...
	{
		if (RoomPropertiesChanged__BackingField != null)
		{
			RoomPropertiesChanged__BackingField();
		}
	}
