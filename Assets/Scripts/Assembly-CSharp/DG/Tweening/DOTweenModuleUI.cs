...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
	{
		...
		{
			return DOTween.To(() => target.alpha, (float x) =>
			{
				target.alpha = x;
		...
		public static Tweener DOFillAmount(this Image target, float endValue, float duration)
		{
			...
			return DOTween.To(() => target.fillAmount, (float x) =>
			{
				target.fillAmount = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => new Vector2(target.flexibleWidth, target.flexibleHeight), (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => new Vector2(target.minWidth, target.minHeight), (Vector2 x) =>
			{
				target.minWidth = x.x;
		...
		{
			return DOTween.To(() => new Vector2(target.preferredWidth, target.preferredHeight), (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => target.effectColor, (Color x) =>
			{
		...
		{
			return DOTween.ToAlpha(() => target.effectColor, (Color x) =>
			{
				target.effectColor = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.effectDistance, (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => target.anchoredPosition, (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => target.anchoredPosition3D, (Vector3 x) =>
			{
		...
		{
			return DOTween.To(() => target.anchorMax, (Vector2 x) =>
			{
				target.anchorMax = x;
			}, endValue, duration).SetOptions(snapping).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.anchorMin, (Vector2 x) =>
			{
				target.anchorMin = x;
			}, endValue, duration).SetOptions(snapping).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.pivot, (Vector2 x) =>
			{
				target.pivot = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.sizeDelta, (Vector2 x) =>
			{
				target.sizeDelta = x;
			}, endValue, duration).SetOptions(snapping).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.value, (float x) =>
			{
				target.value = x;
			}, endValue, duration).SetOptions(snapping).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.text, (string x) =>
			{
				target.text = x;
