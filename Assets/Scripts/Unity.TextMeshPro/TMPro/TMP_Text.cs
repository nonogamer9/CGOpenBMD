	...
	public class TMP_Text : MaskableGraphic
	{
		...
		protected virtual Vector2 CalculatePreferredValues(float defaultFontSize, Vector2 marginSize, bool ignoreTextAutoSizing)
		{
			...
			for (int i = 0; m_char_buffer[i] != 0; i++)
			{
				...
				if (num4 == 9 || num4 == 160 || num4 == 8199 || (!char.IsWhiteSpace((char)num4) && num4 != 8203) || m_textElementType == TMP_TextElementType.Sprite)
				{
					...
					bool flag3 = (m_lineJustification & (TextAlignmentOptions)0x10) == (TextAlignmentOptions)16 || (m_lineJustification & (TextAlignmentOptions)8) == (TextAlignmentOptions)8;
		...
		protected virtual void SaveGlyphVertexInfo(float padding, float style_padding, Color32 vertexColor)
		{
			...
			if (m_colorGradientPreset != null)
			{
				...
				characterInfo[characterCount].vertex_BL.color = characterInfo[characterCount].vertex_BL.color * m_colorGradientPreset.bottomLeft;
				TMP_CharacterInfo[] characterInfo2 = m_textInfo.characterInfo;
				int characterCount2 = m_characterCount;
				characterInfo2[characterCount2].vertex_TL.color = characterInfo2[characterCount2].vertex_TL.color * m_colorGradientPreset.topLeft;
				TMP_CharacterInfo[] characterInfo3 = m_textInfo.characterInfo;
				int characterCount3 = m_characterCount;
				characterInfo3[characterCount3].vertex_TR.color = characterInfo3[characterCount3].vertex_TR.color * m_colorGradientPreset.topRight;
				TMP_CharacterInfo[] characterInfo4 = m_textInfo.characterInfo;
				int characterCount4 = m_characterCount;
				characterInfo4[characterCount4].vertex_BR.color = characterInfo4[characterCount4].vertex_BR.color * m_colorGradientPreset.bottomRight;
			}
			if (!m_isSDFShader)
			{
				style_padding = 0f;
