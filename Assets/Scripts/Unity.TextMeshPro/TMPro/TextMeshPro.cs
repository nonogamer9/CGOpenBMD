...
namespace TMPro
{
	...
	public class TextMeshPro : TMP_Text, ILayoutElement
	{
		...
		protected override void GenerateTextMesh()
		{
			...
			int num44 = 0;
			int num45 = 0;
			float num46 = (m_previousLossyScaleY = transform.lossyScale.y);
			...
			for (int j = 0; j < m_characterCount; j++)
			{
				...
				case TextAlignmentOptions.CaplineFlush:
				{
					...
					bool flag12 = (textAlignmentOptions & (TextAlignmentOptions)0x10) == (TextAlignmentOptions)16;
				...
				if (isVisible)
				{
					...
					case TMP_TextElementType.Character:
					{
						...
						num47 = characterInfo[j].scale * num46 * (1f - m_charWidthAdjDelta);
