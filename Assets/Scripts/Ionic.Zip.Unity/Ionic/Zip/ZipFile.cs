...
namespace Ionic.Zip
{
	...
	public class ZipFile : IEnumerable<ZipEntry>, IEnumerable, IDisposable
	{
		...
		{
			EventHandler<SaveProgressEventArgs> saveProgress = SaveProgress;
		...
		{
			EventHandler<ReadProgressEventArgs> readProgress = ReadProgress;
		...
		{
			EventHandler<ExtractProgressEventArgs> extractProgress = ExtractProgress;
		...
		{
			EventHandler<AddProgressEventArgs> addProgress = AddProgress;
			if (addProgress != null)
			{
