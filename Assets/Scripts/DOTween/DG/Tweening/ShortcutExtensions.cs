...
namespace DG.Tweening
{
	public static class ShortcutExtensions
	{
		...
		{
			return DOTween.To(() => target.aspect, (float x) =>
			{
				target.aspect = x;
		...
		{
			return DOTween.To(() => target.backgroundColor, (Color x) =>
			{
		...
		{
			return DOTween.To(() => target.farClipPlane, (float x) =>
			{
		...
		{
			return DOTween.To(() => target.fieldOfView, (float x) =>
			{
		...
		{
			return DOTween.To(() => target.nearClipPlane, (float x) =>
			{
		...
		{
			return DOTween.To(() => target.orthographicSize, (float x) =>
			{
		...
		{
			return DOTween.To(() => target.pixelRect, (Rect x) =>
			{
				target.pixelRect = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.rect, (Rect x) =>
			{
				target.rect = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		public static Tweener DOShakePosition(this Camera target, float duration, float strength = 3f, int vibrato = 10, float randomness = 90f, bool fadeOut = true)
		{
			...
			return DOTween.Shake(() => target.transform.localPosition, (Vector3 x) =>
			{
		...
		public static Tweener DOShakeRotation(this Camera target, float duration, float strength = 90f, int vibrato = 10, float randomness = 90f, bool fadeOut = true)
		{
			...
			return DOTween.Shake(() => target.transform.localEulerAngles, (Vector3 x) =>
			{
		...
		{
			return DOTween.To(() => target.color, (Color x) =>
			{
				target.color = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.intensity, (float x) =>
			{
				target.intensity = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.shadowStrength, (float x) =>
			{
		...
		{
			return DOTween.To(() => startValue, (Color2 x) =>
			{
		...
		public static Tweener DOColor(this Material target, Color endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetColor(property), (Color x) =>
			{
		...
		{
			return DOTween.ToAlpha(() => target.color, (Color x) =>
			{
				target.color = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		public static Tweener DOFade(this Material target, float endValue, string property, float duration)
		{
			...
			return DOTween.ToAlpha(() => target.GetColor(property), (Color x) =>
			{
				target.SetColor(property, x);
			}, endValue, duration).SetTarget(target);
		}
		...
		public static Tweener DOFloat(this Material target, float endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetFloat(property), (float x) =>
			{
		...
		{
			return DOTween.To(() => target.mainTextureOffset, (Vector2 x) =>
			{
		...
		public static Tweener DOOffset(this Material target, Vector2 endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetTextureOffset(property), (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => target.mainTextureScale, (Vector2 x) =>
			{
		...
		public static Tweener DOTiling(this Material target, Vector2 endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetTextureScale(property), (Vector2 x) =>
			{
		...
		public static Tweener DOVector(this Material target, Vector4 endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetVector(property), (Vector4 x) =>
			{
		...
		{
			return DOTween.To(() => new Vector2(target.startWidth, target.endWidth), (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => target.time, (float x) =>
			{
				target.time = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.position, (Vector3 x) =>
			{
				target.position = x;
		...
		{
			return DOTween.To(() => target.localPosition, (Vector3 x) =>
			{
		...
		{
			TweenerCore<Quaternion, Vector3, QuaternionOptions> tweenerCore = DOTween.To(() => target.rotation, (Quaternion x) =>
			{
				target.rotation = x;
			}, endValue, duration);
		...
		{
			TweenerCore<Quaternion, Quaternion, NoOptions> tweenerCore = DOTween.To(PureQuaternionPlugin.Plug(), () => target.rotation, (Quaternion x) =>
			{
				target.rotation = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		{
			TweenerCore<Quaternion, Vector3, QuaternionOptions> tweenerCore = DOTween.To(() => target.localRotation, (Quaternion x) =>
			{
		...
		{
			TweenerCore<Quaternion, Quaternion, NoOptions> tweenerCore = DOTween.To(PureQuaternionPlugin.Plug(), () => target.localRotation, (Quaternion x) =>
			{
				target.localRotation = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		{
			return DOTween.To(() => target.localScale, (Vector3 x) =>
			{
				target.localScale = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(endValue: new Vector3(endValue, endValue, endValue), getter: () => target.localScale, setter: (Vector3 x) =>
			{
				target.localScale = x;
		...
		public static Tweener DOPunchPosition(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1f, bool snapping = false)
		{
			...
			return DOTween.Punch(() => target.localPosition, (Vector3 x) =>
			{
				target.localPosition = x;
		...
		public static Tweener DOPunchScale(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1f)
		{
			...
			return DOTween.Punch(() => target.localScale, (Vector3 x) =>
			{
				target.localScale = x;
		...
		public static Tweener DOPunchRotation(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1f)
		{
			...
			return DOTween.Punch(() => target.localEulerAngles, (Vector3 x) =>
			{
		...
		public static Tweener DOShakePosition(this Transform target, float duration, float strength = 1f, int vibrato = 10, float randomness = 90f, bool snapping = false, bool fadeOut = true)
		{
			...
			return DOTween.Shake(() => target.localPosition, (Vector3 x) =>
			{
				target.localPosition = x;
			}, duration, strength, vibrato, randomness, false, fadeOut).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake)
				.SetOptions(snapping);
		...
		public static Tweener DOShakeRotation(this Transform target, float duration, float strength = 90f, int vibrato = 10, float randomness = 90f, bool fadeOut = true)
		{
			...
			return DOTween.Shake(() => target.localEulerAngles, (Vector3 x) =>
			{
				target.localRotation = Quaternion.Euler(x);
			}, duration, strength, vibrato, randomness, false, fadeOut).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake);
		}
		...
		public static Tweener DOShakeScale(this Transform target, float duration, float strength = 1f, int vibrato = 10, float randomness = 90f, bool fadeOut = true)
		{
			...
			return DOTween.Shake(() => target.localScale, (Vector3 x) =>
			{
				target.localScale = x;
			}, duration, strength, vibrato, randomness, false, fadeOut).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake);
		}
		...
		public static Sequence DOJump(this Transform target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
		{
			...
			Tween yTween = DOTween.To(() => target.position, (Vector3 x) =>
			{
				target.position = x;
			...
			s.Append(DOTween.To(() => target.position, (Vector3 x) =>
			{
				target.position = x;
			}, new Vector3(endValue.x, 0f, 0f), duration).SetOptions(AxisConstraint.X, snapping).SetEase(Ease.Linear)).Join(DOTween.To(() => target.position, (Vector3 x) =>
			{
				target.position = x;
		...
		public static Sequence DOLocalJump(this Transform target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
		{
			...
			bool offsetYSet = false;
			Sequence s = DOTween.Sequence();
			s.Append(DOTween.To(() => target.localPosition, (Vector3 x) =>
			{
				target.localPosition = x;
			}, new Vector3(endValue.x, 0f, 0f), duration).SetOptions(AxisConstraint.X, snapping).SetEase(Ease.Linear)).Join(DOTween.To(() => target.localPosition, (Vector3 x) =>
			{
				target.localPosition = x;
			}, new Vector3(0f, 0f, endValue.z), duration).SetOptions(AxisConstraint.Z, snapping).SetEase(Ease.Linear)).Join(DOTween.To(() => target.localPosition, (Vector3 x) =>
			{
				target.localPosition = x;
			}, new Vector3(0f, jumpPower, 0f), duration / (float)(numJumps * 2)).SetOptions(AxisConstraint.Y, snapping).SetEase(Ease.OutQuad)
				.SetRelative()
		...
		public static TweenerCore<Vector3, Path, PathOptions> DOLocalPath(this Transform target, Vector3[] path, float duration, PathType pathType = PathType.Linear, PathMode pathMode = PathMode.Full3D, int resolution = 10, Color? gizmoColor = null)
		{
			...
			TweenerCore<Vector3, Path, PathOptions> tweenerCore = DOTween.To(PathPlugin.Get(), () => target.localPosition, (Vector3 x) =>
			{
				target.localPosition = x;
			}, new Path(pathType, path, resolution, gizmoColor), duration).SetTarget(target);
			tweenerCore.plugOptions.mode = pathMode;
		...
		{
			return DOTween.To(() => target.timeScale, (float x) =>
			{
				target.timeScale = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		public static Tweener DOBlendableMoveBy(this Transform target, Vector3 byValue, float duration, bool snapping = false)
		{
			...
			return DOTween.To(() => to, (Vector3 x) =>
			{
				Vector3 vector = x - to;
				to = x;
		...
		public static Tweener DOBlendableRotateBy(this Transform target, Vector3 byValue, float duration, RotateMode mode = RotateMode.Fast)
		{
			...
			TweenerCore<Quaternion, Vector3, QuaternionOptions> tweenerCore = DOTween.To(() => to, (Quaternion x) =>
			{
		...
		public static Tweener DOBlendablePunchRotation(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1f)
		{
			...
			Vector3 to = Vector3.zero;
			return DOTween.Punch(() => to, (Vector3 v) =>
			{
