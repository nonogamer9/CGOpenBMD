...
namespace UnityEngine.Purchasing
{
	...
	public class IAPButton : MonoBehaviour
	{
		...
		private void Restore()
		{
			...
			{
				CodelessIAPStoreListener.Instance.ExtensionProvider.GetExtension<IMoolahExtension>().RestoreTransactionID((RestoreTransactionIDState restoreTransactionIDState) =>
				{
